...
def create_geo_ng_iterate():
    ...
    tree_links.new(new_nodes["Math.007"].outputs[0], new_nodes["Group.003"].inputs[1])
...
def create_geo_ng_megasphere():
    ...
    tree_links.new(new_nodes["Group.007"].outputs[3], new_nodes["Group.008"].inputs[6])
